...
```shell
ghcr.io/jeffvan302/rag-runpod:0.1.0
```
...
docker build --platform linux/amd64 -t ghcr.io/jeffvan302/rag-runpod:0.1.0 .
docker run --rm ghcr.io/jeffvan302/rag-runpod:0.1.0 python src/handler.py --test_input '{"input":{"operation":"health","protocolVersion":1}}'
```
